...
class AudioRecorderApp:
    ...
    def record_audio(self):
        ...
        st.write("Saving audio to", self.temp_file_name)
        with wave.open(self.temp_file_name, 'wb') as wf:
            wf.setnchannels(2)
            wf.setsampwidth(2)
    ...
    def analyze_audio(self, file_path):
        ...
        if prediction == 0:
            ...
            if proba_accuracy < 0.3:
                st.write("The person in the audio file is effected by low level of Parkinson's disease.")
            elif proba_accuracy < 0.7:
                st.write("The person in the audio file is effected by medium level of Parkinson's disease.")
            else:
                st.write("The person in the audio file is effected by high level of Parkinson's disease.")
...
class ParkinsonsSymptomsApp:
    ...
    def update_stage_counts(self, stage):
...
if __name__ == "__main__":
    ...
    for symptom in symptoms_app.symptoms:  # Accessing symptoms from the correct object
    ...
    if symptoms_app.selected_symptoms:
        ...
        diet_plans = symptoms_app.get_diet_plans()  # Corrected method name
